...
model = joblib.load(r'C:\Users\admin\OneDrive\Desktop\Guvi Capstone\Capstone3\car_price_prediction_model.pkl')
label_encoders = joblib.load(r'C:\Users\admin\OneDrive\Desktop\Guvi Capstone\Capstone3\label_encoders.pkl')
scalers = joblib.load(r'C:\Users\admin\OneDrive\Desktop\Guvi Capstone\Capstone3\scalers.pkl')

# Load dataset for filtering and identifying similar data
data = pd.read_csv(r'C:\Users\admin\OneDrive\Desktop\Guvi Capstone\Capstone3\car_dekho_cleaned_dataset_Raw.csv')
...
result_background_color = "lavender"  # Cosmic latte or beige color
